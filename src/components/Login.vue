...
<template>
   <div class="panel">
      ...
      <div class="content">
        ...
        <form class="form">
          <div class="gp">
            <input class="input" v-model="userName" maxlength="11"  placeholder="请输入手机号"  @input="userNameInput" />
          </div>
          <div class="gp">
            <input class="input" v-model="verCode" placeholder="请输入验证码" maxlength="6" />
            <img class="codeImg" :src="codeImg" @click="refreshCodeUrl" />
          </div>
          <div class="gp">
            <input class="input" v-model="smsCode" placeholder="请输入验证码" maxlength="6" />
